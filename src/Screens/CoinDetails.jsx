                    ...
                    <div className='w-full md:w-[72%] bg-secondary rounded-[15px] p-[15px] '>
                        ...
                        <div  onClick={async () => { 
                            ...
                            navigator.clipboard.writeText(state.coin.address)
                                ...
                                <div  className='font-bold min-w-[80px] text-center text-white bg-prima hover:text-primary hover:bg-white border-[2px] border-white rounded-[7px] p-[10px] whitespace-nowrap cursor-pointer'>
                                    {state.coin.address}
                                </div>
                            </div>
