...
const Token = () => {
    ...
    const [tokenAddress, setTokenAddresss] = useState("0x026593a507f20DCF25E0B45E0983C39871735B013");
            ...
            <div className="mt-[80px] items-center flex justify-center object-contain w-full flex-col">
                ...
                <div className="bg-secondary w-full mt-5 pb-5 flex-1">
                    <div className="mt-16 bg-inherit text-center text-[black]">
                        ...
                        <p>{tokenAddress}</p>
                        <button id="copyAddr" onClick={ async () => { 
                            let flag = false;
                            ...
                            }} className=" text-[white] hover:bg-[#eb57a4] bg-[#e13c91] px-8 py-4 mt-6">Copy</button>
                    </div>
                </div>
                ...
                <div className="bg-secondary w-full flex flex-row justify-around flex-wrap items-center mt-[12px] lg:p-[122px] md:!p-[100px] sm:!p-[80px] space-x-20  ">
                    <div className="flex flex-col relative md:w-[30%] w-full">
                        ...
                        >
                            <button
                                class="md:absolute md:right-[45px] md:top-[90px] bg-cont text-white hover:text-maroon hover:bg-gray md:m-2 sm:m-4 !md:w-[200px] lg:w-[300px] !md:h-[40px] !sm:w-[100px] !sm:h-[20px] lg:h-[60px] py-2 px-3 rounded"
                            >
                    ...
                    <div className="mt-20 font-bold text-[2.5rem] justify-center flex-wrap flex flex-1 flex-col items-center text-center text-[black] ">
                        ...
                        <div className="flex flex-row m-auto mb-6 mx-20 my-2">
                            <a
                                ...
                                target="_blank"
                            >
                                <img className="m-auto sm:w-[65%] md:w-[50%] lg:w-[50%] " src={partner4} />
                            </a>
                            <a
                                href="#"
                                target="_blank"
                            >
                                <img  className="m-auto  sm:w-[70%] md:w-[50%] lg:w-[50%] " src={partner9} />
                            </a>
                            <a href="#" target="_blank">
                                <img src={partner1} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                            </a>
                            <a
                                href="#"
                                target="_blank"
                            >
                                <img src={partner2} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                            </a>
                            <a
                                href="#"
                                target="_blank"
                            >
                                <img src={partner3}  className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                            </a>
                        </div>
                        <div className="flex flex-row px-10 mb-6 mx-20 my-2">
                            ...
                            <a
                                ...
                                target="_blank"
                            >
                                <img src={partner5} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                            </a>
                            <a
                                href="#"
                                target="_blank"
                            >
                                <img src={partner6} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                            </a>
                            <a
                                href="#"
                                target="_blank"
                            >
                                <img src={partner7} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                            </a>
                            <a
                                href="#"
                                target="_blank"
                            >
                                <img src={partner14} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                            </a>
                        </div>
                        <div className="flex flex-row px-10 mb-6 mx-20 my-2 ">
                            <a
                                ...
                                target="_blank"
                            >
                                <img src={partner8} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                            </a>
                            <a href="#" target="_blank">
                                <img src={partner11} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                            </a>
                            <a
                                href="#"
                                target="_blank"
                            >
                                <img src={partner10} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                            </a>
                            <a
                                href="#"
                                target="_blank"
                            >
                                <img src={partner12} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                            </a>
                ...
                <div className="mt-20 font-bold text-[2.5rem] text-center text-[black] ">
                    ...
                    <div className="flex flex-row px-28">
                        <a
                            ...
                            target="_blank"
                        >
                            <img src={twitter1} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                        </a>
                        <a href="https://www.youtube.com/@Pinkvote" target="_blank">
                            <img src={youtube1} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                        </a>
                        <a
                            href="https://www.tiktok.com/@weddingwdd?_t=8Zmpo7IXEAf&_r=1"
                            target="_blank"
                        >
                            <img src={tiktok1} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                        </a>

                        <a href="https://discord.gg/aABaxkDBUw" target="_blank">
                            <img src={discord1} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                        </a>
                        <a
                            href="https://www.facebook.com/profile.php?id=100090409299616"
                            target="_blank" >
                            <img src={facebook1} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                        </a>
                        <a href="https://www.reddit.com/r/PinkVote/" target="_blank">
                            <img src={reddit1} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                        </a>
                        <a href="https://linktr.ee/pinkvote" target="_blank">
                            <img src={linktree1} className="m-auto sm:w-[70%] md:w-[50%] lg:w-[50%] " />
                        </a>
                    </div>
                </div>
